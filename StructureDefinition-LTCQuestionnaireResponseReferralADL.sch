...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:QuestionnaireResponse">
      <sch:assert test="count(f:item) &gt;= 10">item: minimum cardinality of 'item' is 10</sch:assert>
      <sch:assert test="count(f:item) &lt;= 10">item: maximum cardinality of 'item' is 10</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
