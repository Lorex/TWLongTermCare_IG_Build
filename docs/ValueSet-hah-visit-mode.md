# 在宅急症－訪視方式值集 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **在宅急症－訪視方式值集**

## ValueSet: 在宅急症－訪視方式值集 
...
* [在宅急症－訪視方式](StructureDefinition-ExtHAHVisitMode.md)
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "http://ltc-ig.fhir.tw/CodeSystem/hah-visit-mode"
    }]
  }
}
