# 肥胖度測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **肥胖度測量範例**

## Example Observation: 肥胖度測量範例

Profile: [身體組成分析儀－肥胖度](StructureDefinition-PASportObservationObesityDegree.md)
...
```json
{
  ...
  "id" : "pasport-observation-obesity-degree-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationObesityDegree"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
