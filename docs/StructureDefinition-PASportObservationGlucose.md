# 基礎生理量測－血糖 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **基礎生理量測－血糖**

## Resource Profile: 基礎生理量測－血糖 

| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationGlucose | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:PASportObservationGlucose |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/PASportObservationGlucose)
...
Other representations of profile: [CSV](StructureDefinition-PASportObservationGlucose.csv), [Excel](StructureDefinition-PASportObservationGlucose.xlsx), [Schematron](StructureDefinition-PASportObservationGlucose.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 1,
      "patternString" : "Glucose [Mass/volume] in blood"
    },
    {
