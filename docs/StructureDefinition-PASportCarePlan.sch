...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan/f:activity">
      <sch:assert test="count(f:progress) &gt;= 1">progress: minimum cardinality of 'progress' is 1</sch:assert>
      <sch:assert test="count(f:progress) &lt;= 1">progress: maximum cardinality of 'progress' is 1</sch:assert>
