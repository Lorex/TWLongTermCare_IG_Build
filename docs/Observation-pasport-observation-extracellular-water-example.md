# 細胞外水分測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **細胞外水分測量範例**

## Example Observation: 細胞外水分測量範例

Profile: [身體組成分析儀－細胞外水分](StructureDefinition-PASportObservationExtracellularWater.md)
...
**value**: 13.2 kg (Details: UCUM codekg = 'kg')
...
```json
{
  ...
  "id" : "pasport-observation-extracellular-water-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationExtracellularWater"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
