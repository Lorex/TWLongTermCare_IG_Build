# 安全防護－跌倒紀錄 - 臺灣長期照顧實作指引(TW LTC IG) v1.0.0
...
| Active as of 2026-03-01 | *Computable Name*:LTCObservationFallingHistory |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/tw.iii.ltc|current/StructureDefinition/LTCObservationFallingHistory)
