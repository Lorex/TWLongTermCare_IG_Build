# 基礎生理量測－脈搏血氧飽和度 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **基礎生理量測－脈搏血氧飽和度**

## Resource Profile: 基礎生理量測－脈搏血氧飽和度 

| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationPeripheralOxygenSaturation | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:PASportObservationPeripheralOxygenSaturation |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/PASportObservationPeripheralOxygenSaturation)
...
Other representations of profile: [CSV](StructureDefinition-PASportObservationPeripheralOxygenSaturation.csv), [Excel](StructureDefinition-PASportObservationPeripheralOxygenSaturation.xlsx), [Schematron](StructureDefinition-PASportObservationPeripheralOxygenSaturation.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 1,
      "patternString" : "Oxygen saturation in Arterial blood"
    },
    {
