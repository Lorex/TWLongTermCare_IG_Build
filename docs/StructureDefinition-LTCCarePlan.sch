...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile TWCoreCarePlan
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:basedOn</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:replaces</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:partOf</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:encounter</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:contributor</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:goal</sch:title>
