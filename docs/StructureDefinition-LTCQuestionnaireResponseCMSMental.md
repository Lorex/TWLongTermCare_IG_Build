# 照顧管理評估量表－情緒及行為型態問卷回覆 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCQuestionnaireResponseCMSMental | *Version*:1.1.0 |
| Active as of 2026-09-17 | *Computable Name*:LTCQuestionnaireResponseCMSMental |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-LTCQuestionnaireResponseCMSMental.json)
