# 長期照護管理中心個案服務初篩表/轉介單文件架構 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCCompositionReferral | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:LTCCompositionReferral |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/LTCCompositionReferral)
