# 蛋白質重測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **蛋白質重測量範例**

## Example Observation: 蛋白質重測量範例

Profile: [身體組成分析儀－蛋白質重](StructureDefinition-PASportObservationProtein.md)
...
**value**: 9.8 kg (Details: UCUM codekg = 'kg')
...
```json
{
  ...
  "id" : "pasport-observation-protein-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationProtein"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
