...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile TWCoreCareTeam
  ...
  <sch:pattern>
    <sch:title>f:CareTeam/f:subject</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:CareTeam/f:participant/f:member</sch:title>
