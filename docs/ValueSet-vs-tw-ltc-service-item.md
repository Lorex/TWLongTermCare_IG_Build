# 長照 SDK－服務項目（計畫） - 臺灣長期照顧實作指引(TW LTC IG) v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **長照 SDK－服務項目（計畫）**

## ValueSet: 長照 SDK－服務項目（計畫） 

| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-service-item | *Version*:1.0.0 |
| Active as of 2026-04-02 | *Computable Name*:VS_TW_LTC_ServiceItem |

 
此 ValueSet 用於表示長照 SDK 中的服務項目（計畫）。 
