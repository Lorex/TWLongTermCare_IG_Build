# 長照 SDK－評估核定摘要欄位碼 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-assessment-component | *Version*:1.1.0 |
| Active as of 2026-09-17 | *Computable Name*:VS_TW_LTC_AssessmentComponent |
| *Other Identifiers:*OID:2.25.27344063291874303920991704683432444884 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.27344063291874303920991704683432444884"
  }],
  "version" : "1.1.0",
