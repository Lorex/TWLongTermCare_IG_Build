# 基礎生理量測－身高 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationHeight | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:PASportObservationHeight |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/PASportObservationHeight)
