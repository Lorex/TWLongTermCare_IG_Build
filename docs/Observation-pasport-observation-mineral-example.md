# 礦物質重測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **礦物質重測量範例**

## Example Observation: 礦物質重測量範例

Profile: [身體組成分析儀－礦物質重](StructureDefinition-PASportObservationMineral.md)
...
**value**: 3.45 kg (Details: UCUM codekg = 'kg')
...
```json
{
  ...
  "id" : "pasport-observation-mineral-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationMineral"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
