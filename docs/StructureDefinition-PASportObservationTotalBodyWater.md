# 身體組成分析儀－身體總水分 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-PASportObservationTotalBodyWater.json)
