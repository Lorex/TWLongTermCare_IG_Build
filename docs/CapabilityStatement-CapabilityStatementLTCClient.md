# 臺灣長期照顧實作指引 - 用戶端能力聲明 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **臺灣長期照顧實作指引 - 用戶端能力聲明**

## CapabilityStatement: 臺灣長期照顧實作指引 - 用戶端能力聲明 

| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/CapabilityStatement/CapabilityStatementLTCClient | *Version*:0.4.1 |
| Active as of 2024-12-19 | *Computable Name*: |

 
此 CapabilityStatement 定義了臺灣長期照顧實作指引中用戶端系統建議支援的 FHIR RESTful API 功能。 

 [Raw OpenAPI-Swagger Definition file](CapabilityStatementLTCClient.openapi.json) | [Download](CapabilityStatementLTCClient.openapi.json) 
...
```json
{
  ...
  "id" : "CapabilityStatementLTCClient",
  "url" : "http://ltc-ig.fhir.tw/CapabilityStatement/CapabilityStatementLTCClient",
  "version" : "0.4.1",
  ...
  "rest" : [{
    "mode" : "client",
    "documentation" : "臺灣長期照顧實作指引用戶端建議支援以下 FHIR RESTful API 功能",
    "security" : {
      "cors" : true,
      "service" : [{
        "coding" : [{
    ...
    "resource" : [{
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Bundle 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Bundle 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Bundle 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Bundle 資源"
      }],
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Composition 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Composition 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Composition 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Composition 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Patient 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Patient 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Patient 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Patient 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 CarePlan 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 CarePlan 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 CarePlan 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 CarePlan 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 CareTeam 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 CareTeam 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 CareTeam 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 CareTeam 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Condition 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Condition 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Condition 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Condition 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Goal 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Goal 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Goal 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Goal 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 MedicationAdministration 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 MedicationAdministration 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 MedicationAdministration 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 MedicationAdministration 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Observation 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Observation 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Observation 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Observation 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Organization 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Organization 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Organization 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Organization 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Practitioner 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Practitioner 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Practitioner 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Practitioner 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 PractitionerRole 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 PractitionerRole 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 PractitionerRole 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 PractitionerRole 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 Questionnaire 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 Questionnaire 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 Questionnaire 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 Questionnaire 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 QuestionnaireResponse 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 QuestionnaireResponse 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 QuestionnaireResponse 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 QuestionnaireResponse 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
    ...
    },
    {
      ...
      "interaction" : [{
        "code" : "read",
        "documentation" : "建議支援讀取 RelatedPerson 資源"
      },
      {
        "code" : "search-type",
        "documentation" : "建議支援搜尋 RelatedPerson 資源"
      },
      {
        "code" : "create",
        "documentation" : "建議支援建立 RelatedPerson 資源"
      },
      {
        "code" : "update",
        "documentation" : "建議支援更新 RelatedPerson 資源"
      }],
      "versioning" : "versioned-update",
      "conditionalCreate" : true,
      "conditionalUpdate" : true,
