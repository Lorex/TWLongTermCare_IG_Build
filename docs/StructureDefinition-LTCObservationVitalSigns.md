# 長期照顧－生命體徵 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCObservationVitalSigns | *Version*:1.1.0 |
| Active as of 2026-09-17 | *Computable Name*:LTCObservationVitalSigns |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-LTCObservationVitalSigns.json)
