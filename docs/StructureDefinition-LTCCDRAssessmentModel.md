# 臨床失智評估量表評估 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCCDRAssessmentModel | *Version*:1.1.0 |
| Active as of 2026-09-17 | *Computable Name*:LTCCDRAssessmentModel |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-LTCCDRAssessmentModel.json)
