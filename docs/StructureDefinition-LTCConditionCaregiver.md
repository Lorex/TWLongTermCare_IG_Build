# 長期照顧－看護狀況 - 臺灣長期照顧實作指引(TW LTC IG) v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCConditionCaregiver | *Version*:1.0.0 |
| Active as of 2026-04-02 | *Computable Name*:LTCConditionCaregiver |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/tw.iii.ltc|current/StructureDefinition/LTCConditionCaregiver)
