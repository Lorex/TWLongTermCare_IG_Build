# 長期照護醫師意見書 (AA12) 邏輯模型 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/AA12Model | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:AA12Model |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/AA12Model)
