# 長照支付審查－分案審核狀態回覆打包範例 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **長照支付審查－分案審核狀態回覆打包範例**

## Example Bundle: 長照支付審查－分案審核狀態回覆打包範例
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/LTCBundleFeeAuditStatus"]
  },
  "type" : "searchset",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "issue" : [{
        ...
        "expression" : ["Claim.identifier.where(system='http://ltc-ig.fhir.tw/identifier/feeaudit/objid' and value='123456789')"]
      }]
    },
    "search" : {
      "mode" : "outcome"
