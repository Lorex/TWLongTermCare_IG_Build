# 身體活動量測-重量訓練代碼系統 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/CodeSystem/SportTrainingCS-Sport | *Version*:0.4.1 |
