...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile TWCorePractitioner
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:identifier/f:type/f:coding/f:code</sch:title>
    <sch:rule context="f:Practitioner/f:identifier/f:type/f:coding/f:code">
