# 看護狀況值集 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/ValueSet/ReferralConditionCaregiverVS-TWLTC | *Version*:1.1.0 |
| Active as of 2024-08-25 | *Computable Name*:ReferralConditionCaregiverVSTWLTC |
| *Other Identifiers:*OID:2.25.166193561574044356154290069329504631161 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.166193561574044356154290069329504631161"
  }],
  "version" : "1.1.0",
