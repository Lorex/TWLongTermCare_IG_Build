# 長照 SDK－照管全量匯出（Claim） - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-LTC-Claim-Export.json)
