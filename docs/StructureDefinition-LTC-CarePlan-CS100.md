# 長照 SDK－照顧計畫（CS100） - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTC-CarePlan-CS100 | *Version*:1.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:LTCCarePlanCS100 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-LTC-CarePlan-CS100.json)
