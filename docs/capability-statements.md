# Capability Statements - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
* [臺灣長期照顧實作指引 - 伺服器端（LTC IG Server）](CapabilityStatement-CapabilityStatementLTCServer.md)
* [臺灣長期照顧實作指引 - 客戶端（LTC IG Client）](CapabilityStatement-CapabilityStatementLTCClient.md)
