# 體脂肪重測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **體脂肪重測量範例**

## Example Observation: 體脂肪重測量範例

Profile: [身體組成分析儀－體脂肪重](StructureDefinition-PASportObservationBodyFatMass.md)

**status**: Final

**category**: Vital Signs

**code**: Body fat [Mass] Calculated
...
**value**: 18.5 kg (Details: UCUM codekg = 'kg')
...
```json
{
  ...
  "id" : "pasport-observation-body-fat-mass-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationBodyFatMass"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
