# 身體組成分析儀－肌肉量 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **身體組成分析儀－肌肉量**

## Resource Profile: 身體組成分析儀－肌肉量 

| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationSoftLeanMass | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:PASportObservationSoftLeanMass |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.twltc|current/StructureDefinition/PASportObservationSoftLeanMass)
...
Other representations of profile: [CSV](StructureDefinition-PASportObservationSoftLeanMass.csv), [Excel](StructureDefinition-PASportObservationSoftLeanMass.xlsx), [Schematron](StructureDefinition-PASportObservationSoftLeanMass.sch) 
