# 穿戴裝置－步態分析 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationGaitType | *Version*:1.1.0 |
| Active as of 2026-09-17 | *Computable Name*:PASportObservationGaitType |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/tw.iii.ltc|current/StructureDefinition/StructureDefinition-PASportObservationGaitType.json)
