# 身體活動量測-跑步機類型值集 - 臺灣長期照顧實作指引(TW LTC IG) v1.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/ValueSet/TreadmillTypeVS-Sport | *Version*:1.1.0 |
| Active as of 2024-06-04 | *Computable Name*:TreadmillTypeVSSport |
| *Other Identifiers:*OID:2.25.82104155355568824777434375135779318240 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.82104155355568824777434375135779318240"
  }],
  "version" : "1.1.0",
