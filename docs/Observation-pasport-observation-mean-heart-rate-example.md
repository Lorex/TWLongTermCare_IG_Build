# 平均心率測量範例 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **平均心率測量範例**

## Example Observation: 平均心率測量範例

Profile: [基礎生理量測－平均心率](StructureDefinition-PASportObservationMeanHeartRate.md)
...
```json
{
  ...
  "id" : "pasport-observation-mean-heart-rate-example",
  "meta" : {
    "profile" : ["http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationMeanHeartRate"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
