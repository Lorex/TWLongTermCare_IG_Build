# 身體組成分析儀－體脂肪重 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/PASportObservationBodyFatMass | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:PASportObservationBodyFatMass |
