# 長期照顧管理中心個案服務初篩表/轉介單邏輯模型 - 臺灣長期照顧實作指引 (Taiwan Long-Term Care Implementation Guide) v0.4.1
...
| | |
| :--- | :--- |
| *Official URL*:http://ltc-ig.fhir.tw/StructureDefinition/LTCRferralModel | *Version*:0.4.1 |
| Active as of 2026-02-28 | *Computable Name*:LTCRferralModel |
