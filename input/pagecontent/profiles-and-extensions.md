...
- [個案獨立生活能力問卷回覆（LTC QuestionnaireResponse CMS IADL）](StructureDefinition-LTCQuestionnaireResponseCMSIADL.html)
...
- [IADL 失能項目評估問卷回覆（LTC QuestionnaireResponse Referral IADL）](StructureDefinition-LTCQuestionnaireResponseReferralIADL.html)
...
- [脈搏血氧飽和度（PA Sport Observation Pulse Oximetry）](StructureDefinition-PASportObservationPulseOximetry.html)
- [血糖（PA Sport Observation Blood Glucose）](StructureDefinition-PASportObservationBloodGlucose.html)
...
- [平均心率（PA Sport Observation Average Heart Rate）](StructureDefinition-PASportObservationAverageHeartRate.html)
...
- [去脂體重（PA Sport Observation Lean Body Weight）](StructureDefinition-PASportObservationLeanBodyWeight.html)
...
- [腰臀圍比（PA Sport Observation Waist-Hip Ratio）](StructureDefinition-PASportObservationWaistHipRatio.html)
- [肥胖度（PA Sport Observation Obesity Index）](StructureDefinition-PASportObservationObesityIndex.html)
- [體內年齡（PA Sport Observation Biological Age）](StructureDefinition-PASportObservationBiologicalAge.html)
- [肌肉量（PA Sport Observation Muscle Volume）](StructureDefinition-PASportObservationMuscleVolume.html)
- [細胞量（PA Sport Observation Cell Volume）](StructureDefinition-PASportObservationCellVolume.html)
- [推定骨量（PA Sport Observation Estimated Bone Volume）](StructureDefinition-PASportObservationEstimatedBoneVolume.html)
- [水腫指數（PA Sport Observation Edema Index）](StructureDefinition-PASportObservationEdemaIndex.html)

#### 穿戴裝置
- [步態週期（PA Sport Observation Gait Cycle）](StructureDefinition-PASportObservationGaitCycle.html)
- [步態分析（PA Sport Observation Gait Analysis）](StructureDefinition-PASportObservationGaitAnalysis.html)
