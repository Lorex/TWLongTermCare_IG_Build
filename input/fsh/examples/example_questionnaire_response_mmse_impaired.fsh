Instance: ltc-questionnaire-response-mmse-impaired-example
InstanceOf: LTCQuestionnaireResponseMMSE
Title: "簡易智能狀態測驗認知障礙回覆範例"
...
// 定向感 (Orientation) - 項目 1-10 (部分正確，6分)
...
* item[1].text = "現在是什麼季節?"
* item[1].answer[0].valueInteger = 0
...
* item[3].text = "今天是禮拜幾?"
* item[3].answer[0].valueInteger = 0
...
* item[9].answer[0].valueInteger = 0

// 記憶登錄 (Registration) - 項目 11 (部分正確，2分)
* item[10].linkId = "MMSE-11"
* item[10].text = "請重複這三個名稱,按第一次複述結果計分"
* item[10].answer[0].valueInteger = 2

// 注意力和計算 (Attention and Calculation) - 項目 12 (計算困難，2分)
* item[11].linkId = "MMSE-12"
* item[11].text = "請從100開始連續減7,一直減7直到我說停為止。(每減對一次得一分)"
* item[11].answer[0].valueInteger = 2

// 記憶回憶 (Recall) - 項目 13-15 (記憶困難，1分)
* item[12].linkId = "MMSE-13"
* item[12].text = "藍色"
* item[12].answer[0].valueInteger = 0
...
* item[14].text = "火車"
* item[14].answer[0].valueInteger = 0

// 命名 (Naming) - 項目 16-17 (命名困難，1分)
...
* item[16].answer[0].valueInteger = 0

// 複述 (Repetition) - 項目 18 (複述困難，0分)
* item[17].linkId = "MMSE-18"
* item[17].text = "請跟我唸一句話『白紙真正寫黑字』"
* item[17].answer[0].valueInteger = 0

// 三階段指令 (Three-Stage Command) - 項目 19-20 (執行困難，1分)
