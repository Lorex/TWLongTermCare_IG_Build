Instance: ltc-careplan-cs100-standalone-example
InstanceOf: LTCCarePlanCS100
Title: "長照 CS100－照顧計畫獨立（CarePlan）範例"
...
* supportingInfo[0] = Reference(ltc-coverageeligibilityresponse-cs100-example)
...
* activity[0].detail.performer[0] = Reference(ltc-practitioner-cs100-example)
