Instance: ltc-claim-export-dispatch-example
InstanceOf: LTCClaimExport
Title: "長照－照管可提供服務（Claim）範例"
...
// 只列代碼（補 sequence）
* item[+].sequence = 1
* item[=].productOrService = http://ltc-ig.fhir.tw/CodeSystem/cs-tw-ltc-service-item#BA04
* item[+].sequence = 2
* item[=].productOrService = http://ltc-ig.fhir.tw/CodeSystem/cs-tw-ltc-service-item#BA07
* item[+].sequence = 3
* item[=].productOrService = http://ltc-ig.fhir.tw/CodeSystem/cs-tw-ltc-service-item#BA18
* item[+].sequence = 4
* item[=].productOrService = http://ltc-ig.fhir.tw/CodeSystem/cs-tw-ltc-service-item#BA02
* item[+].sequence = 5
* item[=].productOrService = http://ltc-ig.fhir.tw/CodeSystem/cs-tw-ltc-service-item#BA13
