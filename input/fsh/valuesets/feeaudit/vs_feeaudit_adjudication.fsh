ValueSet: VS_TW_LTC_FeeAuditAdjudication
...
* ^identifier[0].value = "urn:oid:2.25.95556605601195974745005247534016076129"

* ^url = "http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-feeaudit-adjudication"
* ^version = "0.1.0"
* ^status = #active
* ^experimental = false
* include codes from system CS_TW_LTC_FeeAuditAdjudication
