ValueSet: VS_TW_LTC_FeeAuditSupportingInfo
...
* ^identifier[0].value = "urn:oid:2.25.118212642271467441236280113162067439725"

* ^url = "http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-feeaudit-supporting-info"
* ^version = "0.1.0"
* ^status = #active
* ^experimental = false
* include codes from system CS_TW_LTC_FeeAuditSupportingInfo
