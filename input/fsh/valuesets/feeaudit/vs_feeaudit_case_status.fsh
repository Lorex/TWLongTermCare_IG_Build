ValueSet: VS_TW_LTC_FeeAuditCaseStatus
...
* ^identifier[0].value = "urn:oid:2.25.29256331818245997122471542520517452484"

* ^url = "http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-feeaudit-case-status"
* ^version = "0.1.0"
* ^status = #active
* ^experimental = false
* include codes from system CS_TW_LTC_FeeAuditCaseStatus
