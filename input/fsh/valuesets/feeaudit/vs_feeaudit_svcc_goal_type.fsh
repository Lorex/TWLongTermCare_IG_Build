ValueSet: VS_TW_LTC_FeeAuditSvccGoalType
...
* ^identifier[0].value = "urn:oid:2.25.96182734810406364532208953971617084104"

* ^url = "http://ltc-ig.fhir.tw/ValueSet/vs-tw-ltc-feeaudit-svcc-goal-type"
* ^version = "0.1.0"
* ^status = #active
* ^experimental = false
* include codes from system CS_TW_LTC_FeeAuditSvccGoalType
