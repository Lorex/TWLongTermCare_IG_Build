...
Extension: ExtensionPatientEducationStatus
Id: ExtensionPatientEducationStatus
Title: "長照機構住民教育程度"
Description: "此 Extension 用以表述長照機構住民的教育程度。"
Context: Patient

* ^url = "http://ltc-ig.fhir.tw/StructureDefinition/EducationStatusExt-TWLTC"
* ^version = "2024-09-02"
* ^status = #active
...
* valueCodeableConcept from $EducationStatusVSTWLTC
