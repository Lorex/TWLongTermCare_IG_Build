...
Profile: PASportObservationBodyAge
...
* code.coding.code = #BodyAge
* code.coding.display 1..1 MS
* code.coding.display = "體內年齡"
...
// Example
Instance: pasport-observation-body-age-example
InstanceOf: PASportObservationBodyAge
Title: "體內年齡測量範例"
