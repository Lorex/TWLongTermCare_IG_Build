...
Profile: PASportObservationWaistHipRate
...
* code.coding.code = #WHR
* code.coding.display 1..1 MS
* code.coding.display = "腰臀圍比"
...
// Example
Instance: pasport-observation-waist-hip-rate-example
InstanceOf: PASportObservationWaistHipRate
Title: "腰臀圍比測量範例"
