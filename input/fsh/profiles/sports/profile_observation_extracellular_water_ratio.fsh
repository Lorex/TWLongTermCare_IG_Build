...
Profile: PASportObservationExtracellularWaterRatio
...
* code.coding.code = #ECWRatio
* code.coding.display 1..1 MS
* code.coding.display = "水腫指數"
...
// Example
Instance: pasport-observation-extracellular-water-ratio-example
InstanceOf: PASportObservationExtracellularWaterRatio
Title: "水腫指數測量範例"
