...
Profile: PASportObservationBodyBoneMass
...
* code.coding.code = #101685-6
* code.coding.display 1..1 MS
* code.coding.display = "Body bone mass"
...
// Example
Instance: pasport-observation-body-bone-mass-example
InstanceOf: PASportObservationBodyBoneMass
Title: "推定骨量測量範例"
