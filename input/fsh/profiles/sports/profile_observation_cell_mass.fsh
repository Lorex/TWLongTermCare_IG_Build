...
Profile: PASportObservationCellMass
...
* code.coding.code = #BodyCellMass
* code.coding.display 1..1 MS
* code.coding.display = "細胞量"
...
// Example
Instance: pasport-observation-cell-mass-example
InstanceOf: PASportObservationCellMass
Title: "細胞量測量範例"
