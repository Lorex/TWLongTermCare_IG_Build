...
Profile: PASportObservationExtracellularWater
...
* code.coding.code = #ECW
* code.coding.display 1..1 MS
* code.coding.display = "細胞外水分"
...
// Example
Instance: pasport-observation-extracellular-water-example
InstanceOf: PASportObservationExtracellularWater
Title: "細胞外水分測量範例"
