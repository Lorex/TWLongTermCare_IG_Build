...
Profile: PASportObservationMineral
...
* code.coding.code = #Mineral
* code.coding.display 1..1 MS
* code.coding.display = "礦物質重"
...
// Example
Instance: pasport-observation-mineral-example
InstanceOf: PASportObservationMineral
Title: "礦物質重測量範例"
