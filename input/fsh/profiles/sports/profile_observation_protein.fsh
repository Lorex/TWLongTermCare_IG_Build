...
Profile: PASportObservationProtein
...
* code.coding.code = #Protein
* code.coding.display 1..1 MS
* code.coding.display = "蛋白質重"
...
// Example
Instance: pasport-observation-protein-example
InstanceOf: PASportObservationProtein
Title: "蛋白質重測量範例"
